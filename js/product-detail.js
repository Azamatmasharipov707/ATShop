let productImgItem = document.querySelectorAll('.product-img-item');

productImgItem.forEach(e => {
    e.addEventListener('click', () => {
        let img = e.querySelector('img').getAttribute('src')
        let productImg = document.querySelector('#product-img > img').setAttribute('src', img)
    })
})

let viewAllDescription = document.querySelector('#view-all-description');

viewAllDescription.addEventListener('click', () => {
    // console.log('sadsda');
    let content = document.querySelector('.product-detail-description-content');
    content.classList.toggle('active')
    if (content.classList.contains('active')) {
        viewAllDescription.innerHTML = 'view less' 
    } else {
        viewAllDescription.innerHTML = 'view all'
    }
})
...
let productsList = document.querySelector('#related-products');
